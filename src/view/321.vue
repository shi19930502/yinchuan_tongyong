	...
	export default {
		...
		methods: {
			...
			farmSwiper() {
				...
				var farmSwiper = new Swiper('.farmSwiper', {
					...
					onInit: function(swiper) {
						//						console.log(vm.processEntityList)
					}
				});
			},
			farmSwiperChildren() {
				...
				Object.assign(this.farmSwiperChildrenObj, farmSwiperChildren)
			},
			//点击farmChildren后的弹出层
			farmChildrenClick(swiper) {
				...
				vm.farmSwiperChildrenObj.appendSlide(vm.appendArr);
			...
			videoSwiperOnclick(swiper) {
				...
				vm.removeSwiper();
				vm.popupShow = true;
				console.log(vm.videoShowSwiperObj)
			...
			processSwiper() {
				...
				var process = new Swiper('#process', {
					...
					onInit: function(swiper) {
						...
						//						vm.showSwiperAppendArr(swiper.activeIndex)
